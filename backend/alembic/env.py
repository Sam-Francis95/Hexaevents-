...
import app.database.models.registration
import app.database.models.execution
import app.database.models.reputation

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Overwrite sqlalchemy.url with the environment variable
